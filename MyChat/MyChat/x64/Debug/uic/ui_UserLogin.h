...
public:
    ...
    void setupUi(QWidget *UserLoginClass)
    {
        ...
        verticalLayout_2 = new QVBoxLayout(UserLoginClass);
    ...
    void retranslateUi(QWidget *UserLoginClass)
    {
        ...
        checkBox->setText(QCoreApplication::translate("UserLoginClass", "\350\256\260\344\275\217\345\257\206\347\240\201", nullptr));
